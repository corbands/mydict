...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EmhUser'
        db.create_table(u'users_emhuser', (
            ...
            ('avatar', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'users', ['EmhUser'])


    def backwards(self, orm):
        # Deleting model 'EmhUser'
        db.delete_table(u'users_emhuser')
    ...
    models = {
        ...
        u'users.emhuser': {
            ...
            'avatar': ('django.db.models.fields.IntegerField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
